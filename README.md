...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a52f8915-0d85-436f-82c7-86befdecc5ff
```

> `a52f8915-0d85-436f-82c7-86befdecc5ff` is the password of the certificate, you can change it to any password you want.
