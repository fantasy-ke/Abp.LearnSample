...
public class TagRepository: EfCoreRepository<BlogSampleDbContext, Tag, Guid>, ITagRepository
{
    public TagRepository(IDbContextProvider<BlogSampleDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
