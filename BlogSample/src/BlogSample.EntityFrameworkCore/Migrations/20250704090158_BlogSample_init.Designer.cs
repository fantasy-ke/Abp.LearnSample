...
{
    [DbContext(typeof(BlogSampleDbContext))]
    [Migration("20250704090158_BlogSample_init")]
    partial class BlogSample_init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogSample.Blogs.Blog", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("BlogSample.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlogSample.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlogSample.Tags.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlogSample.Comments.Comment", b =>
                {
                    b.HasOne("BlogSample.Posts.Post", null)
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlogSample.Comments.Comment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BlogSample.Posts.Post", b =>
                {
                    b.HasOne("BlogSample.Blogs.Blog", null)
                        .WithMany()
                        .HasForeignKey("BlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("BlogSample.Posts.PostTag", "Tags", b1 =>
                        {
                            ...
                            b1.ToTable("AppPostTags", (string)null);
