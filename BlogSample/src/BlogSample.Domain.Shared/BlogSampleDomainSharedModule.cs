...
public class BlogSampleDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<BlogSampleDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<BlogSampleResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/BlogSample");

            options.DefaultResourceType = typeof(BlogSampleResource);
        ...
        {
            options.MapCodeNamespace("BlogSample", typeof(BlogSampleResource));
        });
    }
}
