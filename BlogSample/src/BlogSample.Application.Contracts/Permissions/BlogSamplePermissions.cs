...
public static class BlogSamplePermissions
{
    public const string GroupName = "BlogSample";
    ...
    {
        return ReflectionHelper.GetPublicConstantsRecursively(typeof(BlogSamplePermissions));
    }
